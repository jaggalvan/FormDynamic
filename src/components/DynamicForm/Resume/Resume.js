...
export default function Resume({showModal, setStep, setModal}) {
    ...
    const additionalHobbie =localStorage.getItem('adittionalHobbie')
  ...
  return (
    <Modal show={showModal} size="lg" aria-labelledby="contained-modal-title-vcenter" centered onHide={clearForm} >
